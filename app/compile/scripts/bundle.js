...
var _PageScroll = __webpack_require__(4);
...
new _PageScroll2.default((0, _jquery2.default)('#facilities'), "85%");
new _PageScroll2.default((0, _jquery2.default)('.services-item'), "90%");
new _PageScroll2.default((0, _jquery2.default)('.testimonials'), "70%");
...
var PageScroll = function () {
    function PageScroll(els, offset) {
            ...
            this.itemToDisplay.each(function () {
                ...
                new Waypoint({
                    ...
                    handler: function handler() {
                        (0, _jquery2.default)(currentItem).addClass("display-item--is-visible");
                    },
...
var StickyHeader = function () {
    function StickyHeader() {
        ...
        this.headerLink = (0, _jquery2.default)(".generic-nav a");
    ...
    _createClass(StickyHeader, [{
        ...
        key: 'createLinkWayPoints',
        value: function createLinkWayPoints() {
            var currentObj = this;
                ...
                new Waypoint({
                    ...
                    handler: function handler(direction) {
                        if (direction == "down") {
                            ...
                            (0, _jquery2.default)(anchorLink).addClass("is-active");
                        }
                    },
                    offset: "-15%"
                });
